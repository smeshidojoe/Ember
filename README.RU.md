...
<!-- Замените ССЫЛКА_НА_РУССКУЮ_ВЕРСИЮ и ССЫЛКА_НА_АНГЛИЙСКУЮ_ВЕРСИЮ на реальные
     ссылки после загрузки на GitHub (например на README.md и README.en.md в репозитории). -->
...
# с поддержкой --cookies-from-browser и тестами
